...
class CosyVoiceFrontEnd:
    ...
    def frontend_zero_shot(self, tts_text, prompt_text, prompt_speech_16k, resample_rate=22050):
        tts_text_token, tts_text_token_len = self._extract_text_token(tts_text)
    ...
    def frontend_cross_lingual(self, tts_text, prompt_speech_16k, resample_rate=22050):
